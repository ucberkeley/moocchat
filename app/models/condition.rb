class Condition < ActiveRecord::Base
  ...
  #has_one :activity_schema 
  has_one :time_filler, :class_name => "ActivitySchema"#, :foreign_key => "time_filler_activity_schema_id"
  ...
  attr_accessible :name, :prologue_pages, :body_pages, :epilogue_pages,:preferred_group_size, :minimum_group_size, :body_repeat_count, :time_filler #:activity_schema#:time_filler_activity_schema
