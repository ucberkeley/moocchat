...
public class TestBestImage extends TestBase {
    
    public static final String SAMPLE_NAME = "best_image";
    
    public static void main(String[] args) {
        TestRunner.run(TestBestImage.class);
    }

    public TestBestImage(String arg0) {
        super(arg0);
    }
