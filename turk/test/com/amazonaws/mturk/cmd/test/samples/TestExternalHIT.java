...
public class TestExternalHIT extends TestBase {
    
    public static final String SAMPLE_NAME = "external_hit";
    
    public static void main(String[] args) {
        TestRunner.run(TestExternalHIT.class);
    }

    public TestExternalHIT(String arg0) {
        super(arg0);
    }
