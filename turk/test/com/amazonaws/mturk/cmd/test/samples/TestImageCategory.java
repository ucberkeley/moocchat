...
public class TestImageCategory extends TestBase {
    
    public static final String SAMPLE_NAME = "image_category";
    
    public static void main(String[] args) {
        TestRunner.run(TestImageCategory.class);
    }

    public TestImageCategory(String arg0) {
        super(arg0);
    }
