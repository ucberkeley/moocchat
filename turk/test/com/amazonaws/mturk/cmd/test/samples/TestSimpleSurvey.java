...
public class TestSimpleSurvey extends TestBase {
    
    public static final String SAMPLE_NAME = "simple_survey";
    
    public static void main(String[] args) {
        TestRunner.run(TestSimpleSurvey.class);
    }

    public TestSimpleSurvey(String arg0) {
        super(arg0);
    }
