...
public class TestSiteFilter extends TestBase {
    
    public static final String SAMPLE_NAME = "site_filter";
    
    public static void main(String[] args) {
        TestRunner.run(TestSiteFilter.class);
    }

    public TestSiteFilter(String arg0) {
        super(arg0);
    }
